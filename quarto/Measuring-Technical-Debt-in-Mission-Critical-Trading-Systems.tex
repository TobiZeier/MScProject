...
\item
  To evaluate the framework by testing ranking stability under weight
  and temporal variation, and by assessing whether the resulting
  rankings are coherent with independent operational evidence.
\end{enumerate}
...
Genovese, 2023). Practitioners weigh these dimensions together rather
than applying a single factor (Alfayez \emph{et al.}, 2023), and
Lenarduzzi \emph{et al.} (2021) concluded that the absence of a
validated, quantitative, multi-criteria framework remains a central
...
regulated, vendor-heavy trading IT, that mismatch leaves important forms
of debt only partially visible and difficult to govern effectively
...
weight to the remaining three indicators (\(w_j = 0.13333\) each),
reflecting a practitioner judgement that service recovery time and
omitting to install updates and patches carry greater operational
...
\(w_{\text{IncFreq}} = w_{\text{Patch}} = w_{\text{UnsupComp}} \approx 0.13333\).
...
\pandocbounded{\includegraphics[keepaspectratio]{images/topsis_ranking2025_equal.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/topsis_ranking2025_adjust.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/topsis_ranking2024_equal.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/topsis_ranking2024_adjust.png}}
