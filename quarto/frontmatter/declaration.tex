...
\begin{itemize}
  ...
  \item I have made use of AI tools in the preparation of this thesis. The tools employed and the nature of their use are detailed below:
    \begin{itemize}
      ...
      \item \textbf{Purpose:} I used these tools to improve the clarity, grammar, and consistency of the writing, and to support the initial organisation of the thesis structure.
