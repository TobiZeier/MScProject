...
| Reference | Focus / Approach | Data Level | Service-Level Indicators | Multi-Criteria Prioritisation | Financial / Regulated IT | Key Gap |
|---|---|---|---|---|---|---|
| @kruchtenTechnicalDebtMetaphor2012; @fowlerTechnicalDebtQuadrant2009; @cunninghamWyCashPortfolioManagement1992 | TD taxonomy and metaphor | Conceptual | ✗ | ✗ | ✗ | No measurement or prioritisation mechanism |
| @biazottoTechnicalDebtManagement2024; @amanatidisEvaluatingAgreementTechnical2020; @ampatzoglouSDK4EDPlatformTechnical2022 | Static analysis and code-level tools | Code | ✗ | ✗ | ✗ | Inapplicable to vendor-hosted platforms |
| @lenarduzziSystematicLiteratureReview2021; @pinaTechnicalDebtPrioritization2022; @alfayezHowSonarQubeidentifiedTechnical2023 | TD prioritisation strategies | Code / backlog | ✗ | Partial | ✗ | Single criterion; no operational data |
| @stochelBusinessdrivenTechnicalDebt2023; @wieseITManagersPerspective2023 | Business-driven TD valuation | Development | ✗ | ✗ | ✗ | No service-level operational signals |
| @hakiDigitalNudgingTechnical2023; @rollandExploringTensionsManagement2021 | TD in financial services | Organisational | Partial | ✗ | ✓ | No quantitative ranking output |
| @bankerTechnicalDebtFirm2020; @ramasubbuControllingTechnicalDebt2021; @rinta-kahilaGettingTrappedTechnical2023 | Enterprise COTS and outsourcing debt | System / firm | ✗ | ✗ | ✓ | No prioritisation framework |
| @forsgrenAccelerate2018; @nordExamplesTechnicalDebts2021; @paudelExploringRelationshipTechnical2025; @nielsenITPortfolioManagement2022 | DORA metrics as TD proxies | Service | ✓ | ✗ | Partial | Single-criterion; no ranking instrument |
| @tizioSoftwareUpdatesStrategies2023; @markkanenPatchManagementPlanning2023; @nursePatchNotPatch2025 | Patch management and vulnerability debt | Service / infrastructure | Partial | ✗ | Partial | Not integrated into TD prioritisation |
| @albarakManagingTechnicalDebt2022; @khanIntegratedMethodologyRanking2022; @zytoonDecisionSupportModel2020 | TOPSIS and MCDM in IT contexts | Controlled / synthetic | ✗ | ✓ | ✗ | No live operational data; no trading IT context |
| **This study** | **TOPSIS framework on ITSM/CMDB data** | **Service** | **✓** | **✓** | **✓** | — |

: Overview of related work and research gap {#tbl-lit-overview tbl-colwidths="[28,22,10,10,10,10,10]"}
