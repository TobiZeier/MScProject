...
The computation follows the TOPSIS formulation specified in @sec-frameworkdesign and was executed using the Python artefact in Appendix A. This process calculates the closeness coefficient $C_i$ for each service based on its Euclidean distance from the ideal solution. 